...
cur_folder = __dir__
f ="/simple_method_args.rb"
path = cur_folder + f
code = File.read(path)
ast = Parser::CurrentRuby.parse(code)
res = browse(ast)
res = flatten_hash(res).to_s.gsub! '=>',':'
map_ast_simple_method_args = File.new(cur_folder+"/map_source_simple_method_args","w")
map_ast_simple_method_args.write(res)
map_ast_simple_method_args.close
ast_simple_method_args= File.new(cur_folder+"/ast_simple_method_args","w")
ast_simple_method_args.write(ast)
ast_simple_method_args.close